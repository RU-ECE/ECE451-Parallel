...
* 16:332:563 for grads or 16:332:331 for undergrads
* 16:332:351: Programming Methodology-II & Data Structures (or equivalent)
...
Because students today may have a Mac running an ARM CPU, we will provide online facilities for Intel, but if you can
compile on your own intel machine this will lighten the load on the central resources. Everyone is expected to get an
account on Amarel, the Rutgers research cluster, and to use the resource carefully as we are guests.
...
* Classes include slides and live coding in a number of C/C++ derivative languages and APIs. You are encouraged to
...
* **Attendance:**    Attendance is crucial for an effective learning but will not be graded. Your work will speak for
  itself.
