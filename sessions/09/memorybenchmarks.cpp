...
int main() {
	constexpr auto n = 1024 * 1024 * 128;
	auto src = static_cast<unsigned long*>(aligned_alloc(32, n * sizeof(unsigned long)));
	auto dest = static_cast<unsigned long*>(aligned_alloc(32, n * sizeof(unsigned long)));
	// first warm up
