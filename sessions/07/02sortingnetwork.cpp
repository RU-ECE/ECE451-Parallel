...
void transpose(__m256i& a, __m256i& b, __m256i& c, __m256i& d, __m256i& e, __m256i& f, __m256i& g, __m256i& h) {
    __m256i temp1 = _mm256_unpacklo_epi32(a, b);
    __m256i temp2 = _mm256_unpackhi_epi32(a, b);
    __m256i temp3 = _mm256_unpacklo_epi32(c, d);
    __m256i temp4 = _mm256_unpackhi_epi32(c, d);
    __m256i temp5 = _mm256_unpacklo_epi32(e, f);
    __m256i temp6 = _mm256_unpackhi_epi32(e, f);
    __m256i temp7 = _mm256_unpacklo_epi32(g, h);
    __m256i temp8 = _mm256_unpackhi_epi32(g, h);
...
void sortingnetwork8(const uint32_t arr[], uint32_t n) {
    for (uint32_t i = 0; i < n; i += 64) {
        ...
        __m256i temp = __m256i_min_epi32(b, d); // order all pairs in b,d
