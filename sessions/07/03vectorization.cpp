...
void sortingnetwork(__m256 a[], uint32_t n) {
	__m256 a0 = _m256_loadu(a + i); // ymm0
	__m256 a1 = _m256_loadu(a + i + 8); // ymm1
	__m256 a2 = _m256_loadu(a + i + 16); // ymm2

	_m256 temp = _mm256_min_epi32(a0, a1);
	_m256 temp2 = _mm256_max_epi32(a0, a2);
	a0 = temp;
	a1 = temp2;
}
