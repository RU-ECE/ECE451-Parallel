...
void multiplymatrix(float a[], float b[], float c[], const int n) {
	for (auto i = 0; i < n; i++) {
		for (auto j = 0; j < n; j++) {
			c[i * n + j] = 0.0;
			for (auto k = 0; k < n; k++)
...
void multiplymatrix2(float a[], float b[], float c[], const int n) {
	for (auto i = 0; i < n; i++) {
		for (auto j = 0; j < n; j++) {
			float dot = 0.0;
			for (auto k = 0; k < n; k++)
...
void multiplymatrix3(float a[], float b[], float c[], const int n) {
...
void multiplymatrix3b(float a[], float b[], float c[], const int n) {
...
*/
void multiplymatrix4(float a[], float b[], float c[], const int n) {
